...
export const mockEventsUsr: EventInfo[] = [
  {
    id: "1",
    title: "Tech Expo 2023",
    description: "Eine Tech-Veranstaltung zur Präsentation der neuesten Innovationen.",
    category: 4,
  ...
  {
    id: "2",
    title: "Creative Design Days",
    description: "Inspiration, Austausch und Workshops rund ums moderne Design.",
    category: 4,
  ...
  },
  {
    ...
    description: "Ideen und Strategien für nachhaltige Unternehmensentwicklung.",
    category: 1,
    location: "München, Deutschland",
    organization: "Innovate GmbH",
    attendees: 100,
    capacity: 200,
    status: 1,
    start: getRandomDate(),
  ...
  {
    id: "4",
    title: "Finance Future Forum",
    description: "Trends und Technologien in der Finanzwelt von morgen.",
    category: 2,
    location: "Frankfurt, Deutschland",
    organization: "FinForward",
    attendees: 100,
    capacity: 200,
    status: 2,
    start: getRandomDate(),
  ...
  {
    id: "5",
    title: "Sport Tech Connect",
    description: "Technologie trifft auf Bewegung: Die Zukunft des Sports.",
    category: 4,
    location: "Leipzig, Deutschland",
    organization: "NextMove Sports",
    attendees: 100,
    capacity: 200,
    status: 5,
    start: getRandomDate(),
  ...
  {
    id: "6",
    title: "UX & Interface Design Meetup",
    description: "Erfahrungen und Tools im digitalen Designbereich.",
    category: 8,
    location: "Stuttgart, Deutschland",
    organization: "UIX Collective",
    attendees: 100,
    capacity: 200,
    status: 1,
    start: getRandomDate(),
  ...
  },
  {
    ...
    description: "Von der Finanzierung bis zur Skalierung – alles für junge Unternehmen.",
    category: 32,
    location: "Köln, Deutschland",
    organization: "Startup Finances",
    attendees: 100,
    capacity: 200,
    status: 1,
    start: getRandomDate(),
  ...
  },
  {
    ...
    description: "Neue Arbeitsmodelle, Tools und Chancen für Unternehmen.",
    category: 3,
    location: "Hamburg, Deutschland",
    organization: "WorkNext",
    attendees: 100,
    capacity: 200,
    status: 1,
    start: getRandomDate(),
