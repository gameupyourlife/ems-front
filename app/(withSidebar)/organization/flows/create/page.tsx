...
export default function CreateFlowPage() {
    ...
    // Zustände für Lade- und Erstellungsstatus sowie das aktuelle Flow-Objekt
    ...
    useEffect(() => {
        ...
        // Wenn eine templateId vorhanden ist, lade die Vorlage
    ...
    // Funktion zum Erstellen eines neuen Flows
    const handleCreateFlow = async (flow: Flow) => {
        ...
        try {
            if (flow.isTemplate) {
                ...
                // Nach dem Erstellen weiterleiten
                setTimeout(() => {
                    if (eventId) {
