...
export default function allEvents() {
  ...
  const [allEvents] = useState<EventInfo[]>([
    ...
    {
      id: "106",
      title: "Volleyball Spielen",
      description: "Afterwork Volleyball spielen und neue Leute kennenlernen.",
    ...
    {
      id: "109",
      title: "Marketing Fortbildung",
      description: "Lerne die neuesten Trends im digitalen Marketing kennen.",
